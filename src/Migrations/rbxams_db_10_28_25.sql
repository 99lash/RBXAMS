...
--
-- Metadata for table account_status
--

--
-- Metadata for table daily_summary
--
...
('root', 'rbxams_db', 'daily_summary', '{\"sorted_col\":\"`daily_summary`.`user_id` DESC\"}', '2025-10-27 14:59:17');
...
INSERT INTO `pma__table_uiprefs` (`username`, `db_name`, `table_name`, `prefs`, `last_update`) VALUES
('root', 'rbxams_db', 'users', '{\"sorted_col\":\"`users`.`id` ASC\"}', '2025-10-23 03:35:45');
...
--
-- Metadata for database rbxams_db
--
COMMIT;
